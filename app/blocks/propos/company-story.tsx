...
const milestones = [
  { year: "2012", label: "Fondation de RenovaSmart" },
    ...
    <section className={`${styles.section} ${className ?? ""}`}>
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          ...
          <p>
            Fondée en 2012 par Marc Bertrand, artisan peintre passionné, RenovaSmart est née d'une vision simple :
          ...
          <p>
            ...
            du carrelage et des revêtements de sol. Aujourd'hui, RenovaSmart est une référence en Île-de-France
